...
This project utilizes 2022 data from the Federal Reserve Economic Data (FRED) to forecast US unemployment rate (U-3). Independent variables are monthly supply of new housing and interest rate.
